...
import ashutoshsir from "../Assets/Images/QuotesPersonalityImage/ashutoshsir.png"
import shivamsir from "../Assets/Images/QuotesPersonalityImage/shivamsir.png";
import Pranjalsir from "../Assets/Images/QuotesPersonalityImage/Pranjalsir.png";
        ...
        <div className="carousel m-auto w-1/2 my-16">
          <div id="slide1" className="carousel-item relative w-full">
            <div className="flex flex-col items-center justify-center gap-4 px-[15%]">
              ...
              <p className="text-xl text-gray-200">
                "Software Developer at MNC"
              </p>
              {/* for personality name */}
              <h3 className="text-2xl font-semibold">FOUNDER - CodingBullet Ashutosh jha</h3>
            </div>
          ...
          <div id="slide2" className="carousel-item relative w-full">
            <div className="flex flex-col items-center justify-center gap-4 px-[15%]">
              ...
              {/* for writting the quotes */}
              <p className="text-xl text-gray-200">
                "Software developer at OSL"
              </p>
              {/* for personality name */}
              <h3 className="text-2xl font-semibold"> Co founder - Shivam Sen</h3>
            </div>
            <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
          ...
          <div id="slide3" className="carousel-item relative w-full">
            <div className="flex flex-col items-center justify-center gap-4 px-[15%]">
              ...
              {/* for personality name */}
              <h3 className="text-2xl font-semibold">Technical Head - Pranjal Shukla</h3>
            </div>
            <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
              <a href="#slide2" className="btn btn-circle">
                ❮
